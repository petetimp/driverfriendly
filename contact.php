...
<body>
    <div>
        ...
        <div id="df_c_heading"><span>Let Us Know How Our App is Doing</span></div>
        <form method="post" id="contactForm" onSubmit="return false">
            <label class="add_page_label"><span>Name</span>
                <input type="text" placeholder="Name" name="FullName" id="FullName" class="textbox6">
            </label>
            <label class="add_page_label"><span>Email*</span>
                <input type="text"  placeholder="Email*" name="Email" id="Email" class="textbox6">
            </label>
            <label class="add_page_label"><span>Message*</span>
                <textarea name="Message" id="Message" class="textbox1" placeholder="Write your questions or concerns here.*"></textarea>
            </label>
            <div>
                <span class="label6">*Required</span>
            </div>
                <input id="contactButton" class="formButton button1" type="submit" value="Submit">
        </form>
        <div id="mailMsg"></div>
            <div id="animationContainer">
		<div id="loading_c_text"></div>
                <img id="envelope" src="images/email-envelope.gif"/>
            </div>
        <div class="containerbox2" id="containerbox12">
